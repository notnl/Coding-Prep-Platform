      ...
      {allTeamScore.map((team, index) => {
        ...
        return (
          ...
          >
            ...
            {isTopThree && (
              <div className={`absolute inset-0 opacity-5  ${rankColors[index]}`} />
            )}
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${
                  isTopThree 
                    ? ` ${rankColors[index]} text-white font-bold`
                ...
                <div className="flex flex-col">
                  <span className="text-base font-semibold text-gray-900 dark:text-gray-100">
                    Team {Number.parseInt(team.teamID) + 1}
                  </span>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="inline-flex items-center rounded-full  from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 px-3 py-1 text-sm font-semibold text-white shadow-sm transition-transform group-hover:scale-105">
                  {team.teamScore}
